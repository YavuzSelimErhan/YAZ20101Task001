...
int main()
{
	...
	FILE *dosya = fopen("input 1.txt", "r+");
	FILE *dosya1 = fopen("Sifrelenmis.txt", "w+");
    ...
    //Döngünün dosya sonlanýnca bitmesini saðlýyoruz ve dosyadan tanýmlanan karakterleri döngü içinde þifreliyoruz.(Döngünün sebebi boþluk görünce durmasýný önlemek.)
